#ifndef AppArmorPolicyBypasser_H
#define AppArmorPolicyBypasser_H
...
class AppArmorPolicyBypasser : public QObject
{
  Q_OBJECT
...
public:
  explicit AppArmorPolicyBypasser(QObject* parent = 0);
...
#endif // AppArmorPolicyBypasser_H
